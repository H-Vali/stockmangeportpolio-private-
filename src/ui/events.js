...
document.querySelector("#holdingsViewOwnerSelect").addEventListener("change", (event) => {
  uiState.holdingsViewFilter.owner = event.target.value || null;
  renderHoldingsView();
});
document.querySelector("#holdingsViewTypeFilter").addEventListener("change", (event) => {
  uiState.holdingsViewFilter.type = event.target.value || null;
  renderHoldingsView();
});
